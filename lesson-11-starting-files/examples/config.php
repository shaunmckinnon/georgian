<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . '/lesson-11-starting-files/examples/vendors/php-activerecord/ActiveRecord.php';
  ...
  $config['model_directory'] = $_SERVER['DOCUMENT_ROOT'] . '/lesson-11-starting-files/examples/models';
