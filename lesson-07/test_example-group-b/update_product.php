<?php
  ...
  /* Step 3 - Check if the required fields (product_id, name, price, and category_id) are empty */
  ...
  /* Step 6 - Build a SQL string to update the record in the table term1_products based on the product_id */
