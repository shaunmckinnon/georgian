<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . '/project-02/examples/vendors/php-activerecord/ActiveRecord.php';
  ...
  $config['model_directory'] = $_SERVER['DOCUMENT_ROOT'] . '/project-02/examples/models';
