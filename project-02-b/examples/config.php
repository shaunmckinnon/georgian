<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'] . '/project-02-b/examples/vendors/php-activerecord/ActiveRecord.php';
  ...
  $config['model_directory'] = $_SERVER['DOCUMENT_ROOT'] . '/project-02-b/examples/models';
  ...
  function request_is_authenticated ( $request, $whitelist ) {
    if ( !isset( $_SESSION['authenticated'] ) ) {
      if ( !in_array( $request['action'], $whitelist ) ) {
        ...
        header( 'Location: ../superheroes/?action=index' );
        exit;
      }
    }
