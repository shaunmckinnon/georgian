<form action="controller.php" method="post">
  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input class="form-control" type="text" name="first_name" value="<?= isset( $superhero ) ? $superhero->first_name : '' ?>" required maxlength="100">
    </div>

    <div class="form-group">
      <label for="last_name">Last Name</label>
      <input class="form-control" type="text" name="last_name" value="<?= isset( $superhero ) ? $superhero->last_name : '' ?>" required maxlength="100">
    </div>
